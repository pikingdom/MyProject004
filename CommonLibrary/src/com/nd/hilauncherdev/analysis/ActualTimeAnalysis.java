...
public class ActualTimeAnalysis {
	...
	//新手引导新用户推荐主题选择(V7.1增加)
	public static final int README_THEME_NEW = 35;
	//新手引导升级用户推荐主题选择(V7.0.2增加)
	public static final int README_THEME_UPGRADE = 36;
	//新手引导升级用户推荐主题选择(V7.0.3增加)
	public static final int README_APP_UPGRADE = 37;
		...
		ThreadUtil.executeMore(new Runnable() {
			...
			public void run() {
		        ...
		        try {
		            ...
		            ThemeHttpCommon httpCommon = new ThemeHttpCommon(ACTUALTIME_REQUEST_URL);
