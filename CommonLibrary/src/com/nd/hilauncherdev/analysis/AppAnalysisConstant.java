...
public class AppAnalysisConstant {
   ...
   // public static final int SP_INAPP_SYNCHRONOUS_RECOMMENDED_VIDEO  = 28;//inapp同步推荐视屏
    ...
    public static final int SP_LITIAN_WIFI_DOWNLOAD_APP = 441;//力天定制版wifi预加载
    /**
     * 由服务端来入库数据 sp保留
     */
   /* public static final int SP_LAUNCHER_UNINSTALL_RECOMMEND_APP = 98;    //桌面卸载推荐*/
    //800开头是线下的sp配置
    public static final int SP_RECOMMEND_DOCKBAR_BROWER_APP=801;//浏览器推荐应用

    public static final int SP_RECOMMEND_ZERO_GRID_APP=802;//0屏grid 推荐应用

    public static final int SP_RECOMMEND_SEARCH_GRID_APP=803;//搜索界面grid 推荐应用
}
