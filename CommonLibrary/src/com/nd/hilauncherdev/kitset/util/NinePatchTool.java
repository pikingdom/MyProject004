...
public class NinePatchTool {
	...
	/**
	 * 获取普通类型或9patch类型的Drawable
	 * @param path
	 * @return Drawable
	 * @throws Exception
	 */
//	public static Drawable decodeDrawableFromFile(String path) throws Exception {
...
//			Rect padding = new Rect();
//			readPaddingFromChunk(bm.getNinePatchChunk(), padding);
//			NinePatchDrawable d = new NinePatchDrawable(null, bm,
//					bm.getNinePatchChunk(), padding, null);
//			return d;
//		}
//	}
