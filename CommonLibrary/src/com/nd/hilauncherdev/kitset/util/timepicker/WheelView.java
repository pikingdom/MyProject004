...
/*	public boolean isCyclic() {
	...
	private int getDesiredHeight(Layout layout) {
		...
		int desired = getItemHeight() * visibleItems - ITEM_OFFSET * 2 - item_height;
	...
	/**
	 * Returns text item by index 获取item值
	 * 
	 * @param index
	 *            the item index
	...
	/**
	 * Builds text depending on current value 构建要绘制的字符串值
	 * 
	...
	private String buildText(boolean useCurrentValue) {
		...
		int addItems = visibleItems / 2 + 1;// visibleItems 3,addItems 2
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (widthLabel > 0) {
			if (labelLayout == null || labelLayout.getWidth() > widthLabel) {
				labelLayout = new StaticLayout(label, valuePaint, widthLabel, Layout.Alignment.ALIGN_NORMAL, 1, item_height, false);
			} else {
	...
	/**
	 * Draws shadows on top and bottom of control 绘制阴影
	 * 
	 * @param canvas
...
//	}
	...
	/**
	 * Draws value and label layout 绘制选中的item文字
	 * 
	 * @param canvas
	 *            the canvas for drawing
	 */
