...
public class AdvertSDKController {
	...
	public static void init(Context context){
		AdvertSDKManager.init(context, Integer.valueOf(CommonGlobal.PID), ChannelUtil.getChannel(context));
...
//	}
	 ...
	 * @param url
	 */
	public static void startAdSdkBrowserActivity(Context ctx, AdvertInfo advertItem, String url, Intent callBackIntent) {
		if(ctx == null)
			return;
