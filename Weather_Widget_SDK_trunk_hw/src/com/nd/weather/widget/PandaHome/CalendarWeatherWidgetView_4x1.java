 ...
 * @brief
 *
 * @<b>文件名</b>      : CalendarWeatherWidgetView_4x1
...
//	private static final Class<?> WIDGET_PROVIDER = WidgetPandaProvider_4x1.class;
	...
	//
	public CalendarWeatherWidgetView_4x1(final Context context, AttributeSet attrs) {
		super(context, attrs);
		mWidgetType = WIDGET_4X1;
	}

	public void setHomePackage(String homePackage) {
		//Log.d(TAG, "home: " + homePackage);
	}
	...
	public void onLoad(int widgetId) {
		super.onLoad(widgetId, CALENDAR_WIDGET_LAYOUT_4x1, R.layout.weather_widget_panda_4x1_content);
	}
