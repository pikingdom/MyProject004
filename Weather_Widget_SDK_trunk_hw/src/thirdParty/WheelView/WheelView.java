...
public class WheelView extends View {
	...
	private float shadowsScale = 1.3f;
	// Wheel Values
	...
	private void drawShadows(Canvas canvas) {
		if (shadowsScale > 0.0f) {
			int height = (int) (shadowsScale * getItemHeight());
	 ...
	 * @brief 【设置上下边缘的阴影比例】
	 * 
	 * @n<b>函数名称</b> :setShadowsScale
	 * @param fScale
	 * @return void
	 * @<b>作者</b> : 陈希
	 * @<b>修改</b> :
	 * @<b>创建时间</b> : 2012-5-9上午10:47:46
	 * @<b>修改时间</b> :
	 */
	public void setShadowsScale(float fScale) {
		shadowsScale = fScale;
	}
}
